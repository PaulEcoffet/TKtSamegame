...
class MenuFrame(Frame):
    ...
    def __init__(self, interface):
        ...
        slider_nb_line = Scale(self, orient=HORIZONTAL, from_=2,
    ...
    def new_game(self):
        game = SameGame(self.nb_line, self.nb_col, self.nb_colors)
        self.interface.switch_frame(BoardFrame, game)

    def load_game(self):
        try:
            save = tkinter.filedialog.askopenfile(mode='rb', initialdir = 'saves/')
